...
public final class Constants {
    ...
    public static class Ramasseur {
        public static final int kRamasseurMoteur  = 5; // reseau CAN
        public static final int kPhotoSwitch = 3; // port DIO
        
        public static final int kCompressor = 0; // port PCM
        public static final int kDoubleSolenoidForward = 0; // port Solenoide dans le PCM
        public static final int kDoubleSolenoidReverse = 1; // port Solenoide dans le PCM
    }
    public static class Convoyeur {
        public static final int kConvoyeurMoteur = 8; // reseau CAN
        //public static final int kConvoyeurMotor2 = 7; // reseau CAN
        public static final int kPhotoSwitch2 = 2; // port DIO
    }
    public static class Shooter {
        public static final int kShooterMotor = 1; // reseau CAN
    }
    public static class Grimpeur {
        public static final int kGrimpeurMoteur = 2; // reseau CAN
        public static final int kLimitSwitchHaut = 1; // port DIO
        public static final int kLimitSwitchBas = 0; // port DIO
    }
    ...
    public static class Led {
        public static final int kLedSide1Port = 0; // port PWM
        public static final int kLedSide2Port = 1; // port PWM
    }
}