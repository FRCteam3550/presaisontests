...
/**
 ...
 public void periodic() {
  ...
  // SmartDashboard.putNumber("m_x_position", m_odometry.getPoseMeters().getX());
  // SmartDashboard.putNumber("m_y_position", m_odometry.getPoseMeters().getY());
  // SmartDashboard.putNumber("m_orientation_angle", m_odometry.getPoseMeters().getRotation().getDegrees());
  // // SmartDashboard.putNumber("Simulated_CTRE_EncoderLeft", m_drivetrainSim.getLeftPositionMeters());
  // // SmartDashboard.putNumber("Simulated_CTRE_EncoderRight", m_drivetrainSim.getRightPositionMeters());
  // SmartDashboard.putNumber("Simulated_WPI_EncoderLeft", m_leftEncoder.getDistance());
  // SmartDashboard.putNumber("Simulated_WPI_EncoderRight", m_rightEncoder.getDistance());
  // SmartDashboard.putNumber("RealEncoderLeft", getLeftDistanceM());
  // SmartDashboard.putNumber("RealEncoderRight", getRightDistanceM());

  // SmartDashboard.putNumber("LeftSideEncoderRawPosition", getLeftSideEncoderPosition());
  // SmartDashboard.putNumber("LeftSideEncoderRawVelocity", getLeftSideEncoderVelocity());

  // SmartDashboard.putNumber("RightSideEncoderRawPosition", getRightSideEncoderPosition());
  // SmartDashboard.putNumber("RightSideEncoderRawVelocity", getRightSideEncoderVelocity());

  // SmartDashboard.putNumber("Debugging", getLeftSideEncoderPositionReading());
}
  /** Zero all encoders */
...
public void boostDrive(double getTrigger, double getRawAxisVertical, double getRawAxisHorizontal) {
  ...
  */
  ...
  //   m_led.set(patterns);
  // }
  // public void drawLedPatternsOne() {
  //   ArrayList<Double> LedPatternsOne = new ArrayList<Double>();
  //   LedPatternsOne.add(0.91);
  //   LedPatternsOne.add(0.89);
  //   LedPatternsOne.add(0.85);
  //   LedPatternsOne.add(0.87);
  //   for (int i = 0; i < LedPatternsOne.size(); i++) {
  //     m_led.set(LedPatternsOne.get(i));
  //     try {
  //       Thread.sleep(4250);
  ...
  //   }
  // }
  // public void drawLedPatternsTwo() {
  //   ArrayList<Double> LedPatternsOne = new ArrayList<Double>();
  //   LedPatternsOne.add(0.91);
  //   LedPatternsOne.add(0.89);
  //   LedPatternsOne.add(0.85);
  ...
  //   LedPatternsOne.add(0.91);
  //   LedPatternsOne.add(0.87);
  //   LedPatternsOne.add(0.91); //23e pattern
  //   for (int i = 0; i < LedPatternsOne.size(); i++) {
  //     m_led.set(LedPatternsOne.get(i));
  //     try {
  //       Thread.sleep(1506);
