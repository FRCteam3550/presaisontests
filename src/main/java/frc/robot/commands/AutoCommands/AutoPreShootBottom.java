...
public class AutoPreShootBottom extends SequentialCommandGroup {
  /** Creates a new ShootBottom. */
  public AutoPreShootBottom(SuperSubsystem convoyeur, SuperSubsystem ramasseur, PhotoSwitches photoSwitches, double speed) {
    // Add your commands in the addCommands() call, e.g.
    // addCommands(new FooCommand(), new BarCommand());
    addCommands(
      //new ConvoyorShootUpCommand(convoyeur).withTimeout(0.25),
      new RamasseurRamasseIndividualCommand(ramasseur, speed).withTimeout(1),
