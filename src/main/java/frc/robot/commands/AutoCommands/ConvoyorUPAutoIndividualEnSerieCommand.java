...
public class ConvoyorUPAutoIndividualEnSerieCommand extends CommandBase {
   ...
   */
  public ConvoyorUPAutoIndividualEnSerieCommand(SuperSubsystem convoyeur, PhotoSwitches photoSwitches) {
