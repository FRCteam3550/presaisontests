...
public class Auto2BallesEnseriePropre extends SequentialCommandGroup {
  /** Creates a new Auto1BalleEtRecul2Command. */
  public Auto2BallesEnseriePropre(DriveTrain drivetrain, Grimpeur grimpeur, SuperSubsystem convoyeur, Shooter shooter,
