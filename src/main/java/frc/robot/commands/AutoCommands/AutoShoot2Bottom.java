...
public class AutoShoot2Bottom extends SequentialCommandGroup {
  /** Creates a new ShootBottom. */
  public AutoShoot2Bottom(SuperSubsystem convoyeur, SuperSubsystem ramasseur, Shooter shooter, PhotoSwitches photoSwitches) {
    // Add your commands in the addCommands() call, e.g.
    // addCommands(new FooCommand(), new BarCommand());
    addCommands(
      //new ConvoyorShootUpCommand(convoyeur).withTimeout(0.50),
      new RamasseurRamasseIndividualCommand(ramasseur, 0.5).withTimeout(1)
