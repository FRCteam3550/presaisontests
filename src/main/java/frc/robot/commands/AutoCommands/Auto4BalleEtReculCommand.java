...
public class Auto4BalleEtReculCommand extends SequentialCommandGroup {
  /** Creates a new Auto1BalleEtReculCommand. */
  public Auto4BalleEtReculCommand(DriveTrain drivetrain, Grimpeur grimpeur, SuperSubsystem convoyeur, Shooter shooter, SuperSubsystem ramasseur, PhotoSwitches photoSwitches ,String[] path_to_run) {
