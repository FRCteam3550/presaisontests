...
public class ConvoyorUPAutoIndividualCommand extends CommandBase {
   ...
   */
  public ConvoyorUPAutoIndividualCommand(SuperSubsystem convoyeur, PhotoSwitches photoSwitches) {
