...
public class ShooterShootFSMCommand extends CommandBase {
  @SuppressWarnings({ "PMD.UnusedPrivateField", "PMD.SingularField" })
  private final PhotoSwitches m_photoSwitches;
  private static Shooter m_Shooter;
  private static SuperSubsystem m_convoyeurGauche;
   ...
   */
  public ShooterShootFSMCommand(Shooter shooter,SuperSubsystem m_superSubsystem, SuperSubsystem convoyeur, PhotoSwitches photoSwitches) {
    m_Shooter = shooter;
    m_convoyeurGauche = convoyeur;

    
    // Use addRequirements() here to declare subsystem dependencies.
    addRequirements(m_shooter, m_photoSwitches,);
  }
  public enum State{
    NOSHOOT{
