...
public class ShooterKeepONcommand extends CommandBase {
   ...
   */
  public ShooterKeepONcommand(Shooter shooter, XboxController xboxController) {
    m_shooter = shooter;
    m_pilot = xboxController;
  ...
  @Override
  public void execute() {
    SmartDashboard.putNumber("Shooter Power", m_shooter.returnSpeed());
    m_shooter.setShooterHigh();
