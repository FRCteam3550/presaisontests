...
public class ShootBottom extends SequentialCommandGroup {
  /** Creates a new ShootBottom. */
  public ShootBottom(SuperSubsystem convoyeur, SuperSubsystem ramasseur, Shooter shooter, PhotoSwitches photoSwitches, double speed) {
    // Add your commands in the addCommands() call, e.g.
    // addCommands(new FooCommand(), new BarCommand());
    addCommands(
      // TimeOut was 1 second before, and 4 april it's 0.5
      new ConvoyorShootUpCommand(convoyeur).withTimeout(0.5),
      // TimeOut was 1 second before and 4 april it's 0.5
