...
public class RumbleJoystickLowCommand extends CommandBase {
  ...
  public RumbleJoystickLowCommand(Shooter shooter, XboxController xboxController) {
    m_shooter = shooter;
