...
public class ShooterKeepONLowcommand extends CommandBase {
   ...
   */
  public ShooterKeepONLowcommand(Shooter shooter, XboxController xboxController) {
    m_shooter = shooter;
